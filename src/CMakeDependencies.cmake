...
function(FETCH_LIBRARY)
    # Parse arguments
    set(oneValueArgs NAME GIT_TAG GIT_REPOSITORY)
    ...
    if(NOT ${FETCHLIB_NAME}_FOUND)
        ...
        set(${FETCHLIB_NAME}_SOURCE_DIR ${FETCHLIB_NAME}_SOURCE_DIR CACHE INTERNAL "${FETCHLIB_NAME} source directory")
        set(${FETCHLIB_NAME}_BINARY_DIR ${FETCHLIB_NAME}_BINARY_DIR CACHE INTERNAL "${FETCHLIB_NAME} binary directory")
    else()
        message(STATUS "Found ${FETCHLIB_NAME} locally")
    endif()
endfunction()
