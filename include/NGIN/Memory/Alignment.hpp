...
namespace NGIN::Memory
{
    ...
    [[nodiscard]] inline Size AlignForwardAdjustment(const void* ptr, const Size alignment)
    {
    ...
    [[nodiscard]] inline Size AlignForwardAdjustment(const Size address, const Size alignment)
    {
